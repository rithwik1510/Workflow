...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            // Async shims (Plan 001 freeze fix): these hop each blocking
            // git/gh spawn onto the runtime's blocking pool so a slow git
            // (OneDrive sync stall) can't freeze the main thread / IPC. Same
            // command names + signatures as the sync bodies they wrap.
            crate::git::cmd::git_current_branch,
            crate::git::cmd::git_repo_root,
            crate::git::cmd::git_changed_files,
            crate::git::cmd::git_file_diff,
            crate::git::cmd::git_list_branches,
            crate::git::cmd::git_default_branch,
            crate::git::cmd::git_worktree_add,
            crate::git::cmd::git_worktree_add_existing,
            crate::git::cmd::git_worktree_list,
            crate::git::cmd::git_repo_state,
            crate::git::cmd::git_has_remote,
            crate::git::cmd::git_merge_base,
            crate::git::cmd::git_merge_attempt,
            crate::git::cmd::git_worktree_remove,
            crate::git::cmd::git_branch_delete,
            crate::git::cmd::gh_available,
            crate::git::cmd::gh_pr_create,
